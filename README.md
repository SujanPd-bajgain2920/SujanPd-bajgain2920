...
```json
{
  ...
  "frameworks" : ["ASP.NET Core", "ASP.NET MVC",
                  "ASP.NET Web API", "MAUI Blazor Hybrid"],
  "data"       : ["Entity Framework", "SQL", "Data Modeling"],
...
╠══════════════════════════════════════════════════════════╣
║  → I write tests before I write bugs                     ║
...
+ Microservices      — Scalable, decoupled, resilient
+ Hybrid Mobile Apps — ASP.NET MAUI & Blazor Hybrid
